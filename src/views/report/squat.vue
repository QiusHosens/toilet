...
<script>
    ...
    import { getStatKsp } from '@/api/report';
                ...
                for (let data of res) {
                    ...
                    for (let oneData of data.data) {
                        if (oneData.toiletType == 1) {
                            tableRowData.manNum = oneData.totalUse;
                            manDatas.push(oneData.totalUse);
                        } else if (oneData.toiletType == 2) {
                            tableRowData.womanNum = oneData.totalUse;
                            womanDatas.push(oneData.totalUse);
                        } else if (oneData.toiletType == 3) {
                            tableRowData.thirdNum = oneData.totalUse;
                            thirdDatas.push(oneData.totalUse);
                        }
                    }
